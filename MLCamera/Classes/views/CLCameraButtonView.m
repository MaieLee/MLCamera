...
@interface CLCameraButtonView()<UIGestureRecognizerDelegate>

@property (nonatomic, strong) CLSolidCircleView *bgSolidCircleView;
@property (nonatomic, strong) CLCircleView *circleView;
@property (nonatomic, strong) CLSolidCircleView *upSolidCircleView;
...
@implementation CLCameraButtonView
...
- (void)setUpUI{
    _bgSolidCircleView = [[CLSolidCircleView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height) BgColor:[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.3]];
    [self addSubview:_bgSolidCircleView];
    
    _circleView = [[CLCircleView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
    [self addSubview:_circleView];
    
    CGSize selfSize = self.frame.size;
    CGFloat upSolidW = selfSize.width - 24;
    _upSolidCircleView = [[CLSolidCircleView alloc] initWithFrame:CGRectMake((selfSize.width-upSolidW)/2, (selfSize.width-upSolidW)/2, upSolidW, upSolidW) BgColor:[UIColor whiteColor]];
